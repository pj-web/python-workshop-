...
input_login = driver.find_element(By.XPATH, '//*[@id="LoginControl"]')
input_login.send_keys("dr.gonzo.mail71@gmail.com")
sleep(5)
# //*[@id="LoginControl"]
# /html/body/div[1]/div/div/div/div/form/div/dl[1]/dd/input

input_password = driver.find_element(By.XPATH, '//*[@id="ctrl_password"]')
input_password.send_keys("!sc!PJ!41779!")
# //*[@id="ctrl_password"]
# /html/body/div[1]/div/div/div/div/form/div/dl[2]/dd/ul/li[3]/input
